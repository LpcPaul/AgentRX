...
git clone https://github.com/YOUR_ORG/skill-doctor.git ~/.claude/skills/skill-doctor
...
```bash
# 如果已发布到 ClawHub
clawhub install YOUR_ORG/skill-doctor

# 或手动安装
git clone https://github.com/YOUR_ORG/skill-doctor.git
...
git clone https://github.com/YOUR_ORG/skill-doctor.git ~/.codex/skills/skill-doctor
```
